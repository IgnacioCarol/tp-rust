...
impl AerSocket {
    fn new(
        ...
        AerSocket {
            ...
            actor: Arc::new(aer_actor),
            logger: Arc::new(logger_actor),
            message_sent,
        }
    }

    fn clone(&self) -> AerSocket {
        AerSocket {
...
async fn main() {
    ...
    loop {
        ...
        actor_aer.send(Clear()).await.unwrap();
    }
}
